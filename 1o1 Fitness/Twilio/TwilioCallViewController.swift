...
class TwilioCallViewController: UIViewController {
    ...
    @IBAction func videoToggleTapped(_ sender: Any) {
    ...
    override func viewDidLoad() {
       ...
       // self.title = "1o1 Fitness"
        ...
        navigationView.titleLbl.text = "1o1 Fitness"
...
//        self.disconnectButton.backgroundColor = AppColours.topBarGreen
//        self.micButton.backgroundColor = AppColours.topBarGreen
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.roomTextField.text = self.roomName
